...
import { CartIcon2, EyeIcon, HeartIcon, HeartSolid } from "@/app/assets/icons";
    ...
    >
      <div className="relative flex items-center group">
        ...
        >
          ...
          <span className="absolute -right-1.5 top-2.5 w-0 h-0 border-[7px] border-solid border-transparent border-l-white" />
        </p>
      </div>
    </div>
  );
